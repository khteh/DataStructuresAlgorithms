...
INSTANTIATE_TEST_SUITE_P(
	...
	::testing::Values(make_tuple(3, vector<size_t>{1, 3, 7, 9, 9}, vector<size_t>{5, 6, 8, 9, 10}),
					  ...
					  make_tuple(2, views::iota(1, 7) | ranges::to<vector<size_t>>(), views::iota(5, 11) | ranges::to<vector<size_t>>())));
...
INSTANTIATE_TEST_SUITE_P(
	...
	::testing::Values(make_tuple(2, vector<size_t>{1, 1, 5}),
					  ...
					  make_tuple(4, views::iota(1, 5) | ranges::to<vector<size_t>>()),
