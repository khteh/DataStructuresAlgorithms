...
TEST(BinarySearchTests, MatrixBinarySearchTest) {
	...
	a.clear();
	a = { {1} };
	ASSERT_FALSE(searchMatrix(a, 0));
	ASSERT_TRUE(searchMatrix(a, 1));
	a.clear();
	a = { {1}, {3} };
	ASSERT_TRUE(searchMatrix(a, 1));
	ASSERT_FALSE(searchMatrix(a, 0));
	...
	ASSERT_TRUE(searchMatrix1(a, 5));
	ASSERT_TRUE(searchMatrix1(a, 9));
	ASSERT_TRUE(searchMatrix1(a, 17));
	ASSERT_TRUE(searchMatrix1(a, 30));
	ASSERT_FALSE(searchMatrix1(a, 0));
	a.clear();
	a = { {1}, {2}, {3}, {4}, {5} };
	ASSERT_TRUE(searchMatrix1(a, 2));
	ASSERT_FALSE(searchMatrix1(a, 0));
	a.clear();
	a = { {1, 1} };
	ASSERT_TRUE(searchMatrix1(a, 1));
