...
size_t matrixDistance(size_t, size_t, size_t, size_t);
...
void rotateMatrix90DegressClockwise(vector<vector<long>> &);
void rotateMatrixRTimesAntiClockwise(vector<vector<long>> &, size_t);
