...
// assert(kMarsh(strings) == 1);
	...
	ugrid = {{1, 2, 1},
			 ...
			 {2, 4, 2},
			 {3, 5, 3}};
	assert(6 == PostmanProblem(5, udata, ugrid));
	udata.clear();
	udata = {2, 3};
	ugrid.clear();
	ugrid = {{1, 2, 1}, {1, 3, 3}, {2, 4, 2}, {3, 4, 4}};
	assert(4 == PostmanProblem(4, udata, ugrid));
	...
	ugrid = {{83, 92, 2},
			 ...
			 {56, 89, 3},
			 {22, 51, 4}};
	assert(247 == PostmanProblem(100, udata, ugrid));
	/***** The End *****/
	cout
		<< "Press ENTER to exit";
	getline(cin, str);
