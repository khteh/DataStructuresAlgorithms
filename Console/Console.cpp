...
int main(int argc, char *argv[])
{
	...
	cout << "numeric_limits<int>::min(): " << numeric_limits<int>::min() << " (0x" << hex << numeric_limits<int>::min() << dec << "), numeric_limits<int>::max(): " << numeric_limits<int>::max() << " (0x" << hex << numeric_limits<int>::max() << ")" << endl;
	cout << "numeric_limits<unsigned int>::min(): " << numeric_limits<unsigned int>::min() << " (0x" << hex << numeric_limits<unsigned int>::min() << dec << "), numeric_limits<unsigned int>::max(): " << numeric_limits<unsigned int>::max() << " (0x" << hex << numeric_limits<unsigned int>::max() << ")" << endl;
	cout << "numeric_limits<int32_t>::min(): " << dec << numeric_limits<int32_t>::min() << " (0x" << hex << numeric_limits<int32_t>::min() << dec << "), numeric_limits<int32_t>::max(): " << numeric_limits<int32_t>::max() << " (0x" << hex << numeric_limits<int32_t>::max() << ")" << endl;
	cout << "numeric_limits<long>::min(): " << numeric_limits<long>::min() << " (0x" << hex << numeric_limits<long>::min() << dec << "), numeric_limits<long>::max(): " << numeric_limits<long>::max() << " (0x" << hex << numeric_limits<long>::max() << dec << ")" << endl;
	cout << "numeric_limits<long long>::min(): " << numeric_limits<long long>::min() << " (0x" << hex << numeric_limits<long long>::min() << dec << "), numeric_limits<long long>::max(): " << dec << fixed << numeric_limits<long long>::max() << " (0x" << hex << numeric_limits<long long>::max() << dec << ")" << endl;
#if defined(__GNUC__) || defined(__GNUG__)
	cout << "numeric_limits<__int128>::min(): " << numeric_limits<__int128>::min() << " (0x" << hex << numeric_limits<__int128>::min() << dec << "), numeric_limits<__int128>::max(): " << dec << fixed << numeric_limits<__int128>::max() << " (0x" << hex << numeric_limits<__int128>::max() << dec << ")" << endl;
	...
	cout << "numeric_limits<unsigned __int128>::min(): " << numeric_limits<unsigned __int128>::min() << " (0x" << hex << numeric_limits<unsigned __int128>::min() << dec << "), numeric_limits<unsigned __int128>::max(): " << dec << fixed << numeric_limits<unsigned __int128>::max() << " (0x" << hex << numeric_limits<unsigned __int128>::max() << dec << ")" << endl;
	...
	assert(numeric_limits<__int128>::min() * -1 == numeric_limits<__int128>::min()); // 0x8000_0000_0000_0000 * -1 = 0x8000_0000_0000_0000
#endif
	cout << "numeric_limits<size_t>::min(): " << numeric_limits<size_t>::min() << " (0x" << hex << numeric_limits<size_t>::min() << "), numeric_limits<size_t>::max(): " << dec << fixed << numeric_limits<size_t>::max() << " (0x" << hex << numeric_limits<size_t>::max() << dec << ")" << endl;
	...
	assert(numeric_limits<long long>::min() * -1 == numeric_limits<long long>::min()); // 0x8000_0000_0000_0000 * -1 = 0x8000_0000_0000_0000
	...
	*/
	...
	lmatrix.MatrixDistance(grid1, 0, 1);
	...
	d = round(0.1234, 3);
	d = round(0.1234, 4);
	assert(Factorial<long long>(1) == 1);
	assert(Factorial<long long>(2) == 2);
	assert(Factorial<long long>(3) == 6);
	assert(Factorial<long long>(4) == 24);
	assert(Factorial<long long>(5) == 120);
	assert(Factorial<long long>(20) == 2432902008176640000);
	assert(SequenceSum(0) == 0);
	assert(SequenceSum(1) == 1);
	assert(SequenceSum(5) == 15);
	assert(Fibonacci<long long>(-1) == -1);
	assert(Fibonacci<long long>(0) == 0);
	assert(Fibonacci<long long>(1) == 1);
	assert(Fibonacci<long long>(2) == 1);
	assert(Fibonacci<long long>(3) == 2);
	assert(Fibonacci<long long>(4) == 3);
	assert(Fibonacci<long long>(5) == 5);
	assert(Fibonacci<long long>(6) == 8);
	assert(Fibonacci<long long>(7) == 13);
	assert(Fibonacci<long long>(8) == 21);
	assert(Fibonacci<long long>(9) == 34);
// assert(Fibonacci(90) == 2880067194370816120ULL); Times out!!!
...
#endif
	unsigned long long factorialResult = Factorial<long long>(26);
	...
	cout << "10!: " << (double)Factorial<long long>(10) << " has " << FactorialTrailingZeroesCount(10) << " trailing zeroes." << endl;
	cout << "25!: " << (double)Factorial<long long>(25) << " has " << FactorialTrailingZeroesCount(25) << " trailing zeroes." << endl;
	cout << "26!: " << (double)Factorial<long long>(26) << " has " << FactorialTrailingZeroesCount(26) << " trailing zeroes." << endl;
	data.clear();
	str = "abc";
	a.clear();
	a.resize(25);
	...
	*/
	...
	ltree.PrintTree();
	cgrid1.clear();
	cgrid1 = {{1, 1}, {2, 1}, {1, 2}, {2, 2}};
	assert(2 == cmatrix.LatestDayToCross(2, 2, cgrid1));
	cgrid1.clear();
	cgrid1 = {{1, 1}, {1, 2}, {2, 1}, {2, 2}};
	assert(1 == cmatrix.LatestDayToCross(2, 2, cgrid1));
	cgrid1.clear();
	cgrid1 = {{1, 2}, {2, 1}, {3, 3}, {2, 2}, {1, 1}, {1, 3}, {2, 3}, {3, 2}, {3, 1}};
	assert(3 == cmatrix.LatestDayToCross(3, 3, cgrid1));
	cgrid1.clear();
	cgrid1 = {{12, 6},
			  {3, 4},
			  {2, 9},
