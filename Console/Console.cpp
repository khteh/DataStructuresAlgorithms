...
// assert(kMarsh(strings) == 1);
	...
	ugrid = {{1, 2, 1},
			 ...
			 {2, 4, 2},
			 {3, 5, 3}};
	assert(6 == PostmanProblemWithoutLoop(5, uset, ugrid));
	uset.clear();
	graph.Clear();
	uset = {5, 11, 12, 16, 15};
	ugrid.clear();
	ugrid = {{17, 4, 3},
			 ...
			 {19, 12, 3},
			 {10, 20, 2}};
	assert(54 == PostmanProblemWithoutLoop(20, uset, ugrid, true));
	uset.clear();
	graph.Clear();
	uset = {44, 137, 195, 20, 42, 75, 109, 106, 160, 125};
	ugrid.clear();
	ugrid = {{114, 250, 2},
			 {267, 148, 6},
			 {19, 223, 10},
			 ...
			 {78, 111, 9},
			 {26, 219, 3}};
	assert(1086 == PostmanProblemWithoutLoop(300, uset, ugrid, true));
	...
	ugrid = {{83, 92, 2},
			 ...
			 {56, 89, 3},
			 {22, 51, 4}};
	assert(247 == PostmanProblemWithoutLoop(100, uset, ugrid));
	/***** The End *****/
	cout
		<< "Press ENTER to exit";
	getline(cin, str);
